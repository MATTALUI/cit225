...
@/home/student/cit225/lab8/apply_oracle_lab8.sql
...
-- ----------------------------------------------------------------------
---***Add by student
-- Create a unique index for the transaction table.
...
--Query to verify completion of the procedure nested loop seeding ()
...
-- ----------------------------------------------------------------------
---First Verification query to check the changes in the account table.
