...
-- Call library files.
@/home/student/cit225/lab6/apply_oracle_lab6.sql
...
-- ----------------------------------------------------------------------
-- Step #3b: Add foreign key to RENTAL_ITEM on the RENTAL_ITEM_TYPE column.
-- ----------------------------------------------------------------------
...
-- ----------------------------------------------------------------------
ALTER TABLE rental_item
MODIFY rental_item_type
CONSTRAINT nn_renatl_item_7 NOT NULL;
